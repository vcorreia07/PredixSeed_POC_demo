$(function () {
	/* global $ Highcharts console:true */
	var options = {
		chart: {
			borderWidth: 5,
			borderColor: '#e8eaeb',
		...
		annotations: [{
			...
			events: {
				mouseover: function (e) {
					console.log('MouseOver', e, this); // eslint-disable-line
				},
				mouseout: function (e) {
					console.log('MouseOut', e, this); // eslint-disable-line
				},
				mousedown: function (e) {
					console.log('MouseDown', e, this); // eslint-disable-line
				},
				mouseup: function (e) {
					console.log('MouseUp', e, this); // eslint-disable-line
				},
				click: function (e) {
					console.log('Click', e, this); // eslint-disable-line
				},
				dblclick: function (e) {
					console.log('Double Click', e, this); // eslint-disable-line
				}
			}
		}],
		series: [{
